...
//		mHost = (TabHost) findViewById(android.R.id.tabhost);
		mHost = getTabHost();
		intercept_number = (RadioButton) findViewById(R.id.radio_button0);
		intercept_number.setOnCheckedChangeListener(this);
		intercept_call = (RadioButton) findViewById(R.id.radio_button1);
		intercept_call.setOnCheckedChangeListener(this);
		intercept_message = (RadioButton) findViewById(R.id.radio_button2);
